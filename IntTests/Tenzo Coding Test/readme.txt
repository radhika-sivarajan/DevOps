...
- Do we need subtract the break time to calculate labour_cost
- Dictionary should be values are not available time
- While outputing best and worst hours '-' value
